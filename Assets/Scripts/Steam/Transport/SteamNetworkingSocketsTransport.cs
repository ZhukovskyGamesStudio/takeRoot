// Vendored from Unity multiplayer-community-contributions:
// Transports/com.community.netcode.transport.steamnetworkingsockets (v1.0.1, Heathen Group).
// Only local change: the platform guard below was switched from the upstream
// "#if !DISABLESTEAMWORKS && STEAMWORKSNET && NETCODEGAMEOBJECTS" to the project's
// #if !DISABLESTEAMWORKS idiom — those upstream asmdef versionDefines don't exist in
// Assembly-CSharp, where Steamworks.NET and Netcode are already auto-referenced.
