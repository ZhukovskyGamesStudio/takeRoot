...
public class TacticalRoundAttack : ECSComponent {
    ...
    private void DoRoundAttack() {
        _tacticalInteractable.CommandToExecute.Settler.SettlerData.RoundAttackCooldown =
            ObsoleteCoreEntryPoint.ConfigManager.CreaturesParametersConfig.RoundAttackCooldown;
        HashSet<Vector2Int> attackCells = _tacticalInteractable.CommandToExecute.TacticalInteractable.Gridable.InteractableCells;
