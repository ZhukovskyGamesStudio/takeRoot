...
public abstract class Shooter : ECSComponent {
    ...
    protected ProjectileSelectorType projectileSelectorType;
    ...
    protected virtual void UpdateTarget() {
        ...
        foreach (Zombie zombie in zombies) {
            float distance = Vector2Int.Distance(shooterPosition, zombie.Gridable.GetCenterOnGrid.ToVector2Int());
