namespace AI.Node.Jobs {
	public class Action_FindCraftingStation : BTNode {
		...
		public override BTNodeState Evaluate() {
			if (_settler.Data.craftingTransport.craftingStation != null) return BTNodeState.Success;
			var station = _craftingStation.GetCraftingStationWithJob();
			if (station == null) return BTNodeState.Failure;
