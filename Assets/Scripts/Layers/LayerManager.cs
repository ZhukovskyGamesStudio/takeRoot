...
public class LayerManager : MonoBehaviour
{
    ...
    private readonly List<LayerRenderer> _renderers = new List<LayerRenderer>();
    private readonly Dictionary<int, GameObject> _worldLayers = new Dictionary<int, GameObject>();
