...
public class QuestStage {
    ...
    public void InitializeSteps() {
        for (int i = 0; i < questStepPrefabs.Length; i++) {
            QuestStep questStep = Object.Instantiate(questStepPrefabs[i], new Vector3(999f, 0f, 0f), Quaternion.identity,
                ObsoleteCoreEntryPoint.QuestManager.QuestContainer).GetComponent<QuestStep>();
